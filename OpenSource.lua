...
guiTheme = {
	guiTitle = "G00dB0y Hub",
	windowTitleColor = c3(0.18, 0.55, 1),        -- cleaner cyber blue
	windowTopColor = c3(0.05, 0.05, 0.07),       -- not pure black
	windowBottomColor = c3(0.02, 0.02, 0.04),    -- depth gradient
	windowMinimizedSize = {X = 220, Y = 24},
	windowRegularSize   = {X = 220, Y = 300},
	buttonsTextColor = c3(0.2, 0.6, 1),          -- brighter + readable
	labelsTextColor  = c3(0.8, 0.8, 0.8),        -- softer white
	listTopColor    = c3(0.08, 0.08, 0.1),
	listBottomColor = c3(0.04, 0.04, 0.05)
}

local accessorylimbs = {
	-- HEAD (rotated 180° Y)
	{meshid="90598001824705", textureid="118775118661888", C0=angles(0,3.141592653589793,0), Name="Head"},

	-- ARMS (Y then X rotation)
	{meshid="137702817952968", textureid="135650240593878", C0=angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Arm"},
	{meshid="137702817952968", textureid="135650240593878", C0=angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Arm"},

	{meshid="137702817952968", textureid="135650240593878", C0=angles(0,0,1.5707963267948966)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Arm"},
	{meshid="137702817952968", textureid="135650240593878", C0=angles(0,0,1.5707963267948966)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Arm"},

	{meshid="137702817952968", textureid="135650240593878", C0=angles(1.5707963267948966,0,1.5707963267948966)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Arm"},
	{meshid="137702817952968", textureid="135650240593878", C0=angles(-1.5707963267948966,0,1.5707963267948966)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Arm"},
	...
	{meshid="137702817952968", textureid="135650240593878", C0=angles(2,0,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Arm"},
	{meshid="137702817952968", textureid="135650240593878", C0=angles(2,0,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Arm"},

	{meshid="137702817952968", textureid="135650240593878", C0=cf(0.017,0,-0.23)*angles(-1.4835298641951802,-0.15707963267948966,2.199114857512855)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Arm"},
	{meshid="137702817952968", textureid="135650240593878", C0=cf(0,-0.62,-0.01)*angles(1.6580627893946132,0.15707963267948966,-2.199114857512855)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Arm"},

	-- LEGS (Y then X rotation)
	{meshid="137702817952968", textureid="73798034827573", C0=angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Leg"},
	{meshid="137702817952968", textureid="73798034827573", C0=angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Leg"},

	{meshid="137702817952968", textureid="73798034827573", C0=angles(0,0,1.5707963267948966)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Leg"},
	{meshid="137702817952968", textureid="73798034827573", C0=cf(0,-0.125,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Leg"},

	{meshid="137702817952968", textureid="73798034827573", C0=angles(1.5707963267948966,0,1.5707963267948966)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Leg"},
	{meshid="137702817952968", textureid="73798034827573", C0=angles(-1.5707963267948966,0,1.5707963267948966)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Leg"},
	...
	{meshid="126825022897778", textureid="125975972015302", C0=cf_0, Name="Torso"},
	{meshid="126825022897778", textureid="125975972015302", C0=cf_0, Name="Torso"},
	{meshid="126825022897778", textureid="125975972015302", C0=angles(0,0,1.5707963267948966), Name="Torso"},

	-- EXTRA OFFSETS
	{meshid="137702817952968", textureid="135650240593878", C0=angles(-1.6144295580947547,1.5707963267948966,0)*cf(-0.125,0.3,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Arm"},
	{meshid="137702817952968", textureid="135650240593878", C0=angles(1.5271630954950384,-1.5707963267948966,0)*cf(-0.125,-0.3,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Arm"},
	{meshid="137702817952968", textureid="135650240593878", C0=angles(1.5271630954950384,1.5707963267948966,0)*cf(0.125,-0.3,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Arm"},
	{meshid="137702817952968", textureid="135650240593878", C0=angles(-1.6144295580947547,-1.5707963267948966,0)*cf(0.125,0.3,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Arm"},

	{meshid="137702817952968", textureid="73798034827573", C0=angles(1.5271630954950384,1.5707963267948966,0)*cf(-0.125,-0.35,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Leg"},
	{meshid="137702817952968", textureid="73798034827573", C0=angles(-1.6144295580947547,-1.5707963267948966,0)*cf(-0.125,0.3,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Left Leg"},
	{meshid="137702817952968", textureid="73798034827573", C0=angles(1.5271630954950384,-1.5707963267948966,0)*cf(0.125,-0.35,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Leg"},
	{meshid="137702817952968", textureid="73798034827573", C0=angles(-1.6144295580947547,1.5707963267948966,0)*cf(0.125,0.3,0)*angles(0,1.5707963267948966,0)*angles(1.5707963267948966,0,0), Name="Right Leg"},

	{meshid="126825022897778", textureid="125975972015302", C0=angles(0,0,0.2617993877991494), Name="Torso"}
}
...
local myLabel = lbl("-------Open Source Reanim-------")
insSet(myLabel, "TextColor3", c3(0, 1, 0))

btn("G00dB0y Animation V1", function()
    local t = reanimate()
    ...
    -- Swords
    local Sword1 = getPartFromMesh(4315410540, 4315250791)
    local Sword2 = getPartFromMesh(4315410540, 4794299274)
    local Sword3 = getPartFromMesh(4315410540, 4458626951)
    local Sword4 = getPartFromMesh(4315410540, 4506940486)

    local SwordWeld1 = Sword1 and getPartJoint(Sword1)
    local SwordWeld2 = Sword2 and getPartJoint(Sword2)
    local SwordWeld3 = Sword3 and getPartJoint(Sword3)
    local SwordWeld4 = Sword4 and getPartJoint(Sword4)

    local zeroCF = cf(0,0,0)

    -- Smooth lerp helper
    local function SmoothLerp(current, target, speed)
        local t = 1 - math.exp(-speed * deltaTime)
        return Lerp(current, target, t)
    end

    -- Animate sword helper
    local function AnimateSword(weld, pos, rot, speed)
        if weld then
            weld.C0 = SmoothLerp(weld.C0, cfMul(pos, rot), speed)
        end
    end
    ...
    addmode("default", {
        idle = function()
            raycastlegs()
            velYchg()
            local sin1 = math.sin(sine)
            local sin2 = math.sin(sine*2)

            LeftHip.C0 = SmoothLerp(LeftHip.C0, cfMul(cf(-1, -1 + 0.3*sin1, 0), angles(0, -math.pi/3, 0)), 6)
            RightHip.C0 = SmoothLerp(RightHip.C0, cfMul(cf(1, -1 + 0.1*sin1, 0), angles(0, math.pi/3, 0)), 6)
            RootJoint.C0 = SmoothLerp(RootJoint.C0, cfMul(cf(0, 5 + 2*sin1, 0), angles(-math.pi/2, 0, math.pi)), 6)
            LeftShoulder.C0 = SmoothLerp(LeftShoulder.C0, cfMul(cf(-1, -0.2 + 0.1*sin2, 0), angles(0.872, -math.pi, -math.pi/3)), 6)
            RightShoulder.C0 = SmoothLerp(RightShoulder.C0, cfMul(cf(1, -0.2 + 0.1*sin2, 0), angles(0.872, math.pi, math.pi/3)), 6)
            Neck.C0 = SmoothLerp(Neck.C0, cfMul(cf(0,1,0), angles(-math.pi/2,0,math.pi)), 6)

            AnimateSword(SwordWeld1, cf(0, 5*sin1, -3 + 3*sin1), angles(0,0,8.726*sin2), 8)
            AnimateSword(SwordWeld2, cf(3,0,-1 + 3*sin2), angles(0,0,8.726*sin1), 8)
            AnimateSword(SwordWeld3, cf(-0.202, -0.128, -0.265), angles(0,0,0), 8)
            AnimateSword(SwordWeld4, cf(0,0,0), angles(0,0,3*math.pi/2), 8)
        end,
        ...
        walk = function()
            ...
            local sin5 = math.sin(sine*5)
            local sin10 = math.sin(sine*10)
            local sin3 = math.sin(sine*3)

            RootJoint.C0 = SmoothLerp(RootJoint.C0, cfMul(cf(0, 0.2*sin10,0), angles(-1.919 + 0.087*sin10,0,math.pi)), 8)
            LeftHip.C0 = SmoothLerp(LeftHip.C0, cfMul(cf(-1,-1,-0.25 + 0.25*sin5), angles(0.349 + 1.047*sin5, -math.pi/2 + 0.349*sin5, 0)), 8)
            RightHip.C0 = SmoothLerp(RightHip.C0, cfMul(cf(1,-1,-0.25 + 0.25*-sin5), angles(0.349 + 1.047*-sin5, math.pi/2 + 0.349*sin5, 0)), 8)
            LeftShoulder.C0 = SmoothLerp(LeftShoulder.C0, cfMul(cf(-1,0.5,0), angles(0.349 + 0.698*-sin5, -math.pi/2 + 0.349*sin5,0)), 8)
            RightShoulder.C0 = SmoothLerp(RightShoulder.C0, cfMul(cf(1,0.5,0), angles(0.349 + 0.698*sin5, math.pi/2 + 0.349*sin5,0)), 8)
            Neck.C0 = SmoothLerp(Neck.C0, cfMul(cf(0,1,0), angles(-math.pi/2 + 0.174*-sin10,0,math.pi)), 8)

            AnimateSword(SwordWeld1, cf(0, 5*sin(sine), -3 + 3*sin(sine)), angles(0,0,8.726*sin2), 8)
            AnimateSword(SwordWeld2, cf(4*sin3, 4*sin3, 3 - 2*sin3), angles(0,0,8.726*sin1), 8)
            AnimateSword(SwordWeld3, cf(-0.202, -0.128, -0.265), angles(0,0,0), 8)
            AnimateSword(SwordWeld4, cf(0,0,0), angles(0,0,3*math.pi/2), 8)
        end,
        ...
        jump = function()
            local Vfw,Vrt = velbycfrvec()
            velYchg()
            RootJoint.C0 = SmoothLerp(RootJoint.C0, cfMul(zeroCF, angles(-1.483 + Vfw*0.1, Vrt*-0.05, -math.pi)), 10)

            AnimateSword(SwordWeld1, cf(0, 5*sin(sine), -3 + 3*sin(sine)), angles(0,0,8.726*sin(sine*2)), 10)
            AnimateSword(SwordWeld2, cf(4*sin(sine*3), 4*sin(sine*3), 3 - 2*sin(sine*3)), angles(0,0,8.726*sin(sine)), 10)
            AnimateSword(SwordWeld3, cf(-0.202, -0.128, -0.265), angles(0,0,0), 10)
            AnimateSword(SwordWeld4, cf(0,0,0), angles(0,0,3*math.pi/2), 10)
        end,

        fall = function()
            local Vfw,Vrt = velbycfrvec()
            velYchg()
            RootJoint.C0 = SmoothLerp(RootJoint.C0, cfMul(zeroCF, angles(-1.658 + Vfw*0.1, Vrt*-0.05, -math.pi)), 10)
...
btn("G00dB0y Revolver Reanim V1", function()
    local t = reanimate()
    if type(t) ~= "table" then return end
    ...
    -- Gun
    local Gun = getPartFromMesh(11694171309, 11694499782)
    local GunWeld = Gun and getPartJoint(Gun)

    -- Helper for smooth lerp
    local function SmoothLerp(current, target, speed)
        local t = 1 - math.exp(-speed * deltaTime)
        return Lerp(current, target, t)
    end
    ...
    -- Helper for welds
    local function AnimateWeld(weld, cfTarget, anglesTarget, speed)
        if weld then
            weld.C0 = SmoothLerp(weld.C0, cfMul(cfTarget, anglesTarget), speed)
        end
    end
    ...
    addmode("default", {
        idle = function()
            ...
            RootJoint.C0 = SmoothLerp(RootJoint.C0, angles(-math.pi/2, 0, math.pi), 6)
            RightShoulder.C0 = SmoothLerp(RightShoulder.C0, cfMul(cf(1,0.5 + 0.1*sin1,0), angles(0, 1.4835, math.pi/2)), 6)
            LeftShoulder.C0 = SmoothLerp(LeftShoulder.C0, cfMul(cf(-0.8,0.5,-0.3), angles(0, 7*math.pi/6, -math.pi/2)), 6)
            LeftHip.C0 = SmoothLerp(LeftHip.C0, cfMul(cf(-1,-1,0), angles(0,-math.pi/2,0)), 6)
            RightHip.C0 = SmoothLerp(RightHip.C0, cfMul(cf(1,-1,0), angles(0, math.pi/2,0)), 6)
            Neck.C0 = SmoothLerp(Neck.C0, cfMul(cf(0,1,0), angles(-math.pi/2,0,math.pi)), 6)

            AnimateWeld(GunWeld, cf(1.2,1.7,-1.8), angles(-math.pi/2,0,math.pi), 8)
        end,
        ...
        walk = function()
            ...
            RootJoint.C0 = SmoothLerp(RootJoint.C0, cfMul(cf(0,0.2*sin10,0), angles(-1.9198 + 0.08726*sin10,0,math.pi)), 8)
            LeftHip.C0 = SmoothLerp(LeftHip.C0, cfMul(cf(-1,-1,-0.25 + 0.25*sin5), angles(0.349 + 1.047*sin5, -math.pi/2 + 0.349*sin5,0)), 8)
            RightHip.C0 = SmoothLerp(RightHip.C0, cfMul(cf(1,-1,-0.25 + 0.25*-sin5), angles(0.349 + 1.047*-sin5, math.pi/2 + 0.349*sin5,0)), 8)
            LeftShoulder.C0 = SmoothLerp(LeftShoulder.C0, cfMul(cf(-1,0.5,0), angles(0.349 + 0.698*-sin5, -math.pi/2 + 0.349*sin5,0)), 8)
            RightShoulder.C0 = SmoothLerp(RightShoulder.C0, cfMul(cf(1,0.5,0), angles(0.349 + 0.698*sin5, math.pi/2 + 0.349*sin5,0)), 8)
            Neck.C0 = SmoothLerp(Neck.C0, cfMul(cf(0,1,0), angles(-math.pi/2 + 0.1745*-sin10,0,math.pi)), 8)

            AnimateWeld(GunWeld, cf(1.3, -0.2, -0.8), angles(-math.pi + 0.349*sin5, 0.698*sin5, -math.pi), 8)
        end,
        ...
        jump = function()
            ...
            RootJoint.C0 = SmoothLerp(RootJoint.C0, cfMul(zeroCF, angles(-1.4835 + Vfw*0.1, Vrt*-0.05, -math.pi)), 10)
            RightShoulder.C0 = SmoothLerp(RightShoulder.C0, cfMul(cf(1,0.5,0), angles(4.014 - 0.087*sin((sine+0.5)*4), 1.745 + 0.087*sin((sine+0.25)*4), -math.pi/2)), 10)
            LeftShoulder.C0 = SmoothLerp(LeftShoulder.C0, cfMul(cf(-1,0.5,0), angles(4.014 - 0.087*sin((sine+0.5)*4), -1.745 - 0.087*sin((sine+0.25)*4), math.pi/2)), 10)
            LeftHip.C0 = SmoothLerp(LeftHip.C0, cfMul(cf(-1,-1,0), angles(math.pi/2 - 0.087*sin((sine+0.5)*4), -1.658 + 0.069*sin((sine+0.25)*4), math.pi/2)), 10)
            Neck.C0 = SmoothLerp(Neck.C0, cfMul(cf(0,1,0), angles(-1.396,0,-math.pi - Vrt)), 10)

            AnimateWeld(GunWeld, cf(1.5,3.3,0), angles(0,0,math.pi), 10)
        end,
        ...
        fall = function()
            ...
            RootJoint.C0 = SmoothLerp(RootJoint.C0, angles(-math.pi/2,0,math.pi), 10)
            LeftHip.C0 = SmoothLerp(LeftHip.C0, cfMul(cf(-1,-1,0), angles(0,-math.pi/2,0)), 10)
            RightHip.C0 = SmoothLerp(RightHip.C0, cfMul(cf(1,-1,0), angles(0,math.pi/2,0)), 10)
            LeftShoulder.C0 = SmoothLerp(LeftShoulder.C0, cfMul(cf(-1,0.5,0), angles(1.919, -math.pi/2,0)), 10)
            RightShoulder.C0 = SmoothLerp(RightShoulder.C0, cfMul(cf(1,0.5,0), angles(1.919, math.pi/2,0)), 10)
            Neck.C0 = SmoothLerp(Neck.C0, cfMul(cf(0,1,0), angles(-math.pi/2,0,math.pi)), 10)

            AnimateWeld(GunWeld, cf(1.5,2.3,-1.7), angles(-1.047,0,math.pi), 10)
        end
    })
end)

btn("G00dB0y's Judicator", function()
	local t = reanimate()
	if type(t) ~= "table" then return end
	...
	local BanHammerPart = getPartFromMesh(15427253997, 15427270363)
	local BanHammer = BanHammerPart and getPartJoint(BanHammerPart) or nil

	-- Smooth lerp helper
	local function SmoothLerp(dt, speed)
		return 1 - math.exp(-speed * dt)
	end

	local function AnimateHammer(targetCF, targetAngles, speed)
		if BanHammer then
			local a = SmoothLerp(deltaTime, speed)
			BanHammer.C0 = Lerp(BanHammer.C0, cfMul(targetCF, targetAngles), a)
		end
	end
	...
	addmode("default", {
		idle = function()
			raycastlegs()
			velYchg()
			local a = SmoothLerp(deltaTime, 8)

			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5 + 0.1 * sin(sine + 50), 0), angles(0, 1.3089969389957472, 3.490658503988659)), a)
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1 + 0.1 * sin(sine), -0.2), angles(0, -1.0471975511965976, 0)), a)
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1, 0), angles(-1.5707963267948966, 0, math.pi)), a)
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1 + 0.1 * sin(sine), -0.2), angles(0, 1.0471975511965976, 0)), a)
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5 + 0.1 * sin(sine), 0), angles(0, -1.3089969389957472, 0)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 0.1 * sin(sine), 0), angles(-1.4835298641951802, 0, math.pi)), a)

			AnimateHammer(cf(-3, -3.7 + 0.1 * sin(sine), 0), angles(0, 0, 0.4363323129985824), 8)
		end,
		...
		walk = function()
			...
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, -0.25 + 0.25 * sin(sine * 5)), angles(0.3490658503988659 + 1.0471975511965976 * sin(sine * 5), -1.5707963267948966 + 0.3490658503988659 * sin(sine * 5), 0)), a)
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5, 0), angles(0.3490658503988659 + 0.6981317007977318 * sin(sine * -5), -1.5707963267948966 + 0.3490658503988659 * sin(sine * 5), 0)), a)
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1, -0.25 + 0.25 * sin(sine * -5)), angles(0.3490658503988659 + 1.0471975511965976 * sin(sine * -5), 1.5707963267948966 + 0.3490658503988659 * sin(sine * 5), 0)), a)
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1, 0), angles(-1.5707963267948966 + 0.17453292519943295 * sin(sine * -10), 0, math.pi)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 0.2 * sin(sine * 10), 0), angles(-1.9198621771937625 + 0.08726646259971647 * sin(sine * 10), 0, math.pi)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(0.3490658503988659, 1.5707963267948966, 0)), a)

			AnimateHammer(cf(-4, -4, 0), angles(0, 0, 0.4363323129985824), 8)
		end,
		...
		jump = function()
			...
			RootJoint.C0 = Lerp(RootJoint.C0, angles(-1.5707963267948966, 0, math.pi), a)
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1, 0), angles(0, 1.5707963267948966, 0)), a)
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5, 0), angles(2.792526803190927, -1.5707963267948966, 0)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(2.792526803190927, 1.5707963267948966, 0)), a)
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1, 0), angles(-1.5707963267948966, 0, math.pi)), a)
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, 0), angles(0, -1.5707963267948966, 0)), a)

			AnimateHammer(cf(-5, -3, 0.5), angles(1.5707963267948966, 0, -1.0471975511965976), 8)
		end,
		...
		fall = function()
			...
			RootJoint.C0 = Lerp(RootJoint.C0, angles(-1.5707963267948966, 0, math.pi), a)
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1, 0), angles(0, 1.5707963267948966, 0)), a)
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5, 0), angles(1.7453292519943295, -1.5707963267948966, 0)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(1.7453292519943295, 1.5707963267948966, 0)), a)
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1, 0), angles(-1.5707963267948966, 0, math.pi)), a)
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, 0), angles(0, -1.5707963267948966, 0)), a)

			AnimateHammer(cf(-5, -2.3, 1.5), angles(1.5707963267948966, -0.7853981633974483, -1.0471975511965976), 8)
		end
	})
end)

btn("G00dB0y's Wing Man", function()
	local t = reanimate()
	if type(t) ~= "table" then return end
	...
	-- Wings
	local WingsPart = getPartFromMesh(134028128163195, 86616020446780)
	local Wings = WingsPart and getPartJoint(WingsPart)
	local AccessoryWeld = Wings
	...
	local function AnimateWings(targetCF, targetAngles, speed)
		if Wings or AccessoryWeld then
			local a = SmoothLerp(deltaTime, speed)
			local current = (AccessoryWeld and AccessoryWeld.C0) or Wings.C0
			local c0 = Lerp(current, cfMul(targetCF, targetAngles), a)
			if AccessoryWeld then AccessoryWeld.C0 = c0 end
			if Wings then Wings.C0 = c0 end
		end
	end
	...
	addmode("default", {
		idle = function()
			...
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5, 0), angles(0, -1.3089969389957472, 0)), a)
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1, -0.2), angles(0, 1.3089969389957472, 0)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(0, 1.3089969389957472, 0)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 4 + 2 * sin(sine * 3), 0), angles(-1.3962634015954636, 0, math.pi)), a)
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1, 0), angles(-1.5707963267948966, 0, math.pi)), a)
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, -0.2), angles(0, -1.3089969389957472, 0)), a)

			AnimateWings(cf(0, -1, -4), angles(0, 0, 8.726646259971648 * sin(sine * 1)), 8)
		end,
		...
		walk = function()
			...
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1, 0), angles(-1.5707963267948966 + 0.17453292519943295 * sin(sine * -10), 0, math.pi)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 0.2 * sin(sine * 10), 0), angles(-1.9198621771937625 + 0.08726646259971647 * sin(sine * 10), 0, math.pi)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(0.3490658503988659, 1.5707963267948966, math.pi)), a)

			AnimateWings(cf(-4, -4, 0), angles(0, 0, 0.4363323129985824), 8)
		end,
		...
		jump = function()
			...
			AnimateWings(cf(-5, -3, 0.5), angles(1.5707963267948966, 0, -1.0471975511965976), 8)
		end,
		...
		fall = function()
			...
			AnimateWings(cf(-5, -2.3, 1.5), angles(1.5707963267948966, -0.7853981633974483, -1.0471975511965976), 8)
		end
	})
end)

btn("G00dB0y´s Star Glitcher", function()
	local t = reanimate()
	if type(t) ~= "table" then return end
	...
	local SpinnyPart = getPartFromMesh(4315410540, 4794299274)
	local Spinny = SpinnyPart and getPartJoint(SpinnyPart)
	...
	local function AnimateSpinny(targetCF, angleOffset, speed)
		if Spinny then
			local a = SmoothLerp(deltaTime, speed)
			Spinny.C0 = Lerp(Spinny.C0, cfMul(targetCF, angles(0, 0, angleOffset + sin(sine * speed) )), a)
		end
	end
	...
	addmode("default", {
		idle = function()
			...
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1 + 0.1 * sin(sine * 1), -0.2), angles(0, 1.3089969389957472, 0)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5 + 0.1 * sin(sine * 1), 0), angles(0, 0, -0.6981317007977318)), a)
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5 + 0.1 * sin(sine * 1), 0), angles(0, 0, 0.6981317007977318)), a)
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1 + 0.1 * sin(sine * 1), 0), angles(-1.5707963267948966, 0, 3.141592653589793)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 0.1 * sin(sine * 1), 0), angles(-1.5707963267948966, 0, 2.9670597283903604)), a)
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1 + 0.1 * sin(sine * 1), -0.2), angles(0, -1.3089969389957472, 0)), a)

			AnimateSpinny(cf(0, -2, -2), -0.7853981633974483, 8.726646259971648)
		end,
		...
		walk = function()
			...
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5, 0), angles(0.3490658503988659 + 0.6981317007977318 * sin(sine * -5), -1.5707963267948966 + 0.3490658503988659 * sin(sine * 5), 0)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 0.2 * sin(sine * 10), 0), angles(-1.9198621771937625 + 0.08726646259971647 * sin(sine * 10), 0, 3.141592653589793)), a)
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1, -0.25 + 0.25 * sin(sine * -5)), angles(0.3490658503988659 + 1.0471975511965976 * sin(sine * -5), 1.5707963267948966 + 0.3490658503988659 * sin(sine * 5), 0)), a)
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, -0.25 + 0.25 * sin(sine * 5)), angles(0.3490658503988659 + 1.0471975511965976 * sin(sine * 5), -1.5707963267948966 + 0.3490658503988659 * sin(sine * 5), 0)), a)
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1, 0), angles(-1.5707963267948966 + 0.17453292519943295 * sin(sine * -10), 0, 3.141592653589793)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(0.3490658503988659 + 0.6981317007977318 * sin(sine * 5), 1.5707963267948966 + 0.3490658503988659 * sin(sine * 5), 0)), a)

			AnimateSpinny(cf(0, -2, -3), -0.4363323129985824, 17.453292519943297)
		end,
		...
		jump = function()
			...
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1, 0), angles(-1.5707963267948966, 0, 3.141592653589793)), a)
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1, 0), angles(0, 1.5707963267948966, 0)), a)
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, 0), angles(0, -1.5707963267948966, 0)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 0, 0), angles(-1.5707963267948966, 0, 3.141592653589793)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(2.792526803190927, 1.5707963267948966, 0)), a)
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5, 0), angles(2.792526803190927, -1.5707963267948966, 0)), a)
		...
		fall = function()
			...
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, 0), angles(0, -1.5707963267948966, 0)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 0, 0), angles(-1.5707963267948966, 0, 3.141592653589793)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(1.9198621771937625, 1.5707963267948966, 0)), a)
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5, 0), angles(1.9198621771937625, -1.5707963267948966, 0)), a)
...
btn("G00dB0y´s Winged Demon", function()
	local t = reanimate()
	if type(t) ~= "table" then return end
	...
	local WingedDemon = getPartFromMesh(4315410540, 4315250791)
	WingedDemon = WingedDemon and getPartJoint(WingedDemon)

	local WingedDemon2 = getPartFromMesh(4315410540, 4506940486)
	WingedDemon2 = WingedDemon2 and getPartJoint(WingedDemon2)
	...
	local function AnimateSwords()
		local a = SmoothLerp(deltaTime, 8)
		if WingedDemon then
			WingedDemon.C0 = Lerp(WingedDemon.C0, cfMul(cf(3, -2, 0), angles(0, 0, 0.8726646259971648 * sin(sine * 1))), a)
		end
		if WingedDemon2 then
			WingedDemon2.C0 = Lerp(WingedDemon2.C0, cfMul(cf(2, -1, 0), angles(0, 0, 0.8726646259971648 * sin(sine * 1))), a)
		end
	end
	...
	addmode("default", {
		idle = function()
			...
			Neck.C0 = Lerp(Neck.C0, cfMul(cf(0, 1, 0), angles(-1.5707963267948966, 0, 3.141592653589793)), a)
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, -0.2), angles(0, -1.1344640137963142, 0)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 7 + 3 * sin(sine * 1), 0), angles(-1.3089969389957472, 0, 3.141592653589793)), a)
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1, -0.2), angles(0, 1.1344640137963142, 0)), a)
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.2, 0), angles(2.0943951023931953, 0.7853981633974483, 0.4363323129985824)), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(3.3161255787892263, 0.7853981633974483, -0.4363323129985824)), a)
...
lbl("--------HATLESS REANIMATIONS----------")
btn("G00dB0y´s Xester", function()
	local t = reanimate()
	if type(t) ~= "table" then return end
	...
	addmode("default", {
		...
		jump = function()
			...
			RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1, 0), angles(0, 1.5707963267948966, 0)), a)
			LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, 0), angles(0, -1.5707963267948966, 0)), a)
			RootJoint.C0 = Lerp(RootJoint.C0, angles(-1.5707963267948966, 0, 3.141592653589793), a)
			RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1, 0.5, 0), angles(2.792526803190927, 1.5707963267948966, 0)), a)
			LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1, 0.5, 0), angles(2.792526803190927, -1.5707963267948966, 0)), a)
		end,
...
btn("G00dB0y´s Phantom Flow", function()
    local t = reanimate()
    if type(t) ~= "table" then return end
    ...
    local legRotationAmplitude = math.rad(50)
    local armRotationY = math.rad(20)
    local speed = 3  -- walk speed factor

    addmode("default", {
        idle = function()
            raycastlegs()
            velYchg()
            local sin1 = math.sin(sine*0.5)
            local sin2 = math.sin(sine*1)

            RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, 0.05*sin1, 0), angles(-math.pi/2, 0, math.pi)), deltaTime)
            LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1+0.05*sin1, 0), angles(0, -math.pi/2, 0)), deltaTime)
            RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1+0.05*sin1, 0), angles(0, math.pi/2, 0)), deltaTime)
            LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1,0.5+0.05*sin2,0), angles(0, -math.pi/2, 0.2*sin1)), deltaTime)
            RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1,0.5+0.05*sin2,0), angles(0, math.pi/2, -0.2*sin1)), deltaTime)
            Neck.C0 = Lerp(Neck.C0, cfMul(cf(0,1+0.05*sin1,0), angles(-math.pi/2+0.05*sin2,0,math.pi)), deltaTime)
        end,

        walk = function()
            raycastlegs()
            velYchg()
            local cycle = sine * speed
            local legSin = math.sin(cycle)
            local legCos = math.cos(cycle)

            RootJoint.C0 = Lerp(RootJoint.C0, cfMul(cf(0, stepLength*legSin, 0), angles(-math.pi/2 + 0.02*legSin, 0, math.pi)), deltaTime)
            LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1, -1, 0), angles(0.349 + legRotationAmplitude*legSin, -math.pi/2 + 0.1*legCos, 0)), deltaTime)
            RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1, -1, 0), angles(0.349 - legRotationAmplitude*legSin, math.pi/2 - 0.1*legCos, 0)), deltaTime)

            -- Arms match leg speed exactly
            LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1,0.5,0), angles(0.2*legSin, -math.pi/2 + 0.05*legCos, armRotationY)), deltaTime)
            RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1,0.5,0), angles(-0.2*legSin, math.pi/2 - 0.05*legCos, -armRotationY)), deltaTime)

            Neck.C0 = Lerp(Neck.C0, cfMul(cf(0,1,0), angles(-math.pi/2 + 0.01*legSin,0,math.pi)), deltaTime)
        end,

        jump = function()
            raycastlegs()
            velYchg()
            RootJoint.C0 = Lerp(RootJoint.C0, angles(-math.pi/2,0,math.pi), deltaTime)
            ...
            LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1,0.5,0), angles(2.5,-math.pi/2,armRotationY)), deltaTime)
            RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1,0.5,0), angles(2.5,math.pi/2,-armRotationY)), deltaTime)
        ...
        fall = function()
            ...
            LeftHip.C0 = Lerp(LeftHip.C0, cfMul(cf(-1,-1,0), angles(0,-math.pi/2,0)), deltaTime)
            RightHip.C0 = Lerp(RightHip.C0, cfMul(cf(1,-1,0), angles(0,math.pi/2,0)), deltaTime)
            LeftShoulder.C0 = Lerp(LeftShoulder.C0, cfMul(cf(-1,0.5,0), angles(1.92,-math.pi/2,armRotationY)), deltaTime)
            RightShoulder.C0 = Lerp(RightShoulder.C0, cfMul(cf(1,0.5,0), angles(1.92,math.pi/2,-armRotationY)), deltaTime)
            Neck.C0 = Lerp(Neck.C0, cfMul(cf(0,1,0), angles(-math.pi/2,0,math.pi)), deltaTime)
        end
    })
end)

insSet(btn("stop current script", stopreanimate), "TextColor3", Color3.fromRGB(220, 50, 50))
lbl("--------SETTINGS----------")
